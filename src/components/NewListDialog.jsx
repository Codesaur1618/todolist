    ...
    <Dialog open={dialogState.isOpen} onClose={dialogState.close}>
      ...
      <DialogContent>
        ...
        <TextField
          ...
          fullWidth
          variant="standard"
          color="imprary" // Use "color" prop to adapt text color to the theme
        />
        <Card
          variant="outlined"
          ...
          {filteredIcons.map(([name, Icon]) => (
            ...
            >
              ...
              <Typography
                variant="caption"
                align="center"
                sx={{ textOverflow: 'ellipsis', overflow: 'hidden', color: 'text.primary' }} // Use "color" prop to adapt text color to the theme
              >
                {name}
              </Typography>
            </Box>
      ...
      <DialogActions>
        <Button onClick={dialogState.close} color="primary"> {/* Use "color" prop to adapt button text color to the theme */}
          Cancel
        </Button>
        <Button
          onClick={() => {
          ...
          color="primary" // Use "color" prop to adapt button text color to the theme
        >
          Create
        </Button>
      </DialogActions>
